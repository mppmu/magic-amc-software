  ...
  #define n16 16       //must be twice n8; for the difinition of the arrays
  #define n4000 15000  //length of echo, echoalt
  #define nport 7      //the actual number of active ports
//#define nport 4

  int chainmax = 7 ;   //8: use all for RS485, 7: use last port for USCM
...
//left right top bottom: index
  ...
  int   actaddr2npan[1024], boxaddr2npan[1024];
        //x or y given by address of actuator
  int   itfromactaddr[1024];
