...
int  PWR_read(AMCpower  p[32])
{
  ...
  i = 0 ;
  p[i].deflt=1; strncpy( p[i].str," Ch 1 ",6); p[i].chan= 0; i++; // chain 0       0
  p[i].deflt=1; strncpy( p[i].str," Ch 2 ",6); p[i].chan= 2; i++; // chain 1       1
  p[i].deflt=1; strncpy( p[i].str," Ch 3 ",6); p[i].chan= 4; i++; // chain 2       2
  p[i].deflt=1; strncpy( p[i].str," Ch 4 ",6); p[i].chan= 6; i++; // chain 3       3
  p[i].deflt=1; strncpy( p[i].str," Ch 5 ",6); p[i].chan= 8; i++; // chain 4       4
  p[i].deflt=1; strncpy( p[i].str," Ch 6 ",6); p[i].chan=10; i++; // chain 5       5
  p[i].deflt=1; strncpy( p[i].str," Ch 7 ",6); p[i].chan=12; i++; // chain 6       6
  p[i].deflt=0; strncpy( p[i].str," SBIG ",6); p[i].chan=14; i++; // SBIG          7
  p[i].deflt=1; strncpy( p[i].str," Ch 1b",6); p[i].chan= 1; i++; // chain 8       8
  p[i].deflt=1; strncpy( p[i].str," Ch 2b",6); p[i].chan= 3; i++; // chain 9       9
  p[i].deflt=1; strncpy( p[i].str," Ch 3b",6); p[i].chan= 5; i++; // chain 10     10
  p[i].deflt=1; strncpy( p[i].str," Ch 4b",6); p[i].chan= 7; i++; // chain 11     11
  p[i].deflt=1; strncpy( p[i].str," Ch 5b",6); p[i].chan= 9; i++; // chain 12     12
  p[i].deflt=1; strncpy( p[i].str," Ch 6b",6); p[i].chan=11; i++; // chain 13     13
  p[i].deflt=1; strncpy( p[i].str," Ch 7b",6); p[i].chan=13; i++; // chain 14     14
  //        v0
  p[i].deflt=1; strncpy( p[i].str,"  15  ",6); p[i].chan=15; i++; // free         15
  ...
  //        v0
  p[i].deflt=1 ;strncpy( p[i].str,"empty", 6); p[i].chan=18; i++; // internal     31
